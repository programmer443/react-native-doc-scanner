...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::docscanner::BoundingBox> final {
    static inline margelo::nitro::docscanner::BoundingBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::docscanner::BoundingBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::docscanner::BoundingBox& arg) {
