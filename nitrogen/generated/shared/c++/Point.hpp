...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::docscanner::Point> final {
    static inline margelo::nitro::docscanner::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::docscanner::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::docscanner::Point& arg) {
